...
from .consumers import InventoryItemConsumer, InventorySalesOrderConsumer, LoginUserConsumer
...
websocket_urlpatterns = [
    ...
    path('api_zoho_senitron/ws/users/', LoginUserConsumer.as_asgi(), name='ws_users'),
]
