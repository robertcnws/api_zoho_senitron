...
CELERY_BROKER_URL = env('CELERY_BROKER_URL', default='redis://redis-api-zoho-senitron:6379/0')
CELERY_TASK_DEFAULT_QUEUE = 'ms_main_load_data_queue'
CELERY_TASK_ROUTES = {
    'ms_main_load_data.*': {'queue': 'ms_main_load_data_queue'},
}
CELERY_BROKER_CONNECTION_RETRY_ON_STARTUP = True
CELERY_RESULT_BACKEND = env('CELERY_RESULT_BACKEND', default='redis://redis-api-zoho-senitron:6379/0')
